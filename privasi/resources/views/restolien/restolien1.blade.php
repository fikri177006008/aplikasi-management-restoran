			...
			<ul>
				...
				<li data-transition="slideoverhorizontal"
					...
					<div class="tp-caption" 
						...
						data-splitout="none" 
						data-responsive_offset="on">
						<div class="slide--bio text-center">&copy;Break-out is a restaurant, bar and coffee roastery located Tasikmalaya</div>
					</div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1">
                <div class="banner--desc">
                    &copy;Break-out was the first retaurant to open in Tasikmalaya, the resturant was designed with the history in mind we have created a soft industrial dining room, combined with an open kitchen, coffee take out bar and coffee roastery.
                </div>
            </div>
        </div>
        <!-- .row end -->
