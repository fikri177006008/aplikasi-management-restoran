...
<head>
    ...
    <link href="assets-dash/logo/logo2-hitam.png" rel="icon">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-6">
                    <div class="footer--widget-content">
                        <h3>alamat saya</h3>
                        <p>jalan siliwangi<br> Tasikmlaya, Indonesia</p>
                        <a class="link--styled" href="#">lihat saya di map</a>
                    </div>
                </div>
                <!-- .col-md-3 end -->
                ...
                <div class="col-xs-12 col-sm-3 col-md-6">
                    <div class="footer--widget-content">
                        <h3>kontak kami </h3>
                        <p class="mb-0">177006094@atudent.unsil.ac.id</p>
                        <p class="mb-0">081223119707</p>
                        <a class="link--styled" href="#">kirim Pesan</a>
                    </div>
                </div>
                <!-- .col-md-3 end -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <span>&copy; 2019  <i class="fa fa-heart"></i> by informatika 17
                </div>
            </div>
        </div>
        <!-- .container end -->
